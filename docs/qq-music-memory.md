...
- 当前 web cache-busters 为 app-icon 2、styles 71、platform-wave 15、pointer-silk-trail 6、app 81；GUI/WebGL 平台交接、品牌几何、网易云来源切换/活动进度、右下角状态胶囊栈与鼠标 MeshLine 细节只维护在 `platform-gui-architecture.md`。
