...
- 当前 web cache-busters 为 styles 67、platform-wave 15、pointer-silk-trail 6、app 80；GUI/WebGL 平台交接、网易云来源切换/活动进度、折叠 Inspector 提示与鼠标 MeshLine 细节只维护在 `platform-gui-architecture.md`。
