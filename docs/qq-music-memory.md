...
- 当前 web cache-busters 为 styles 62、platform-wave 15、pointer-silk-trail 6、app 74；GUI/WebGL 平台交接、网易云来源切换动效与鼠标 MeshLine 细节只维护在 `platform-gui-architecture.md`。
