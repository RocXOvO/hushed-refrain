...
- Current release line: `v1.3.1`. A release is valid only when local `main`, `origin/main`, the annotated tag, package/lock, GitHub Release target, exact-SHA Windows workflow, and all five Release assets agree.
...
- Current web cache-busters are `app-icon.png?v=2`, `styles.css?v=70`, `platform-wave.js?v=15`, `pointer-silk-trail.js?v=6`, and `app.js?v=81`; keep them synchronized with `web/index.html`.
